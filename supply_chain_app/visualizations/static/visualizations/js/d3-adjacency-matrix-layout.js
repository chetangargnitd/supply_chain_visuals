...
(function (global, factory) {
  ...
  function d3AdjacencyMatrixLayout () {
    ...
    matrix.xAxis = function (calledG) {
      ...
      calledG.append('g').attr('class', 'am-xAxis am-axis').call(xAxis).selectAll('text').data(nodes).style('text-anchor', 'end').style('fill',function(d){ return color[d.group]; }).attr('transform', 'translate(-10,-10) rotate(90)');
    };
    ...
    matrix.yAxis = function (calledG) {
      ...
      calledG.append('g').attr('class', 'am-yAxis am-axis').call(yAxis).selectAll('text').data(nodes).style('fill',function(d){ return color[d.group]; });
    };
